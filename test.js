...
test('Make sure default development environment is returned', function(t) {
...
test('Make sure passing in an environment returns correct config', function(t) {
...
test('Config should accept overrides with an environment as well', function(t) {
